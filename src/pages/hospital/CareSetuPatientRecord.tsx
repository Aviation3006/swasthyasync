    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 min-w-0">
        <button
          ...
          className="inline-flex items-center gap-2 text-xs font-bold text-slate-600 hover:text-slate-900 transition px-3 py-1.5 rounded-md bg-white border border-slate-200 shadow-2xs"
        >
      ...
      <div className="p-4 rounded-xl bg-slate-900 text-white border border-slate-800 shadow-card flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] px-2 py-0.5 rounded-md bg-emerald-950 text-emerald-300 font-mono font-bold border border-emerald-800">
        ...
        <div className="flex items-center gap-2 text-xs font-medium text-slate-300 bg-slate-800 px-3 py-1.5 rounded-lg border border-slate-700">
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-card p-4 sm:p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 sm:gap-6 min-w-0">
        <div className="flex items-center gap-3 sm:gap-4 min-w-0 flex-1">
          <div className="w-14 h-14 rounded-xl bg-blue-50 text-blue-900 border border-blue-200 flex items-center justify-center font-bold text-xl shadow-xs shrink-0">
        ...
        <div className="bg-rose-50 border border-rose-200 rounded-xl p-3.5 text-xs text-rose-900 shrink-0 w-full md:w-auto">
            ...
            >
              ...
              {tab.badge !== undefined && (
                <span className={`px-1.5 py-0.2 rounded-full text-[10px] font-bold ${
                  isActive ? 'bg-blue-900 text-blue-100' : 'bg-slate-100 text-slate-700'
                }`}>
                  {tab.badge}
                </span>
              )}
          ...
          <CardContent className="space-y-4 text-xs">
            ...
            <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-between">
              ...
              <a
                ...
                className="px-4 py-2 bg-emerald-700 hover:bg-emerald-800 text-white rounded-lg font-bold flex items-center gap-2 shadow-xs"
              >
